...
export const ar = defineLocale({
  sendDiagnostics: {
    ...
    privacyNotice:
      'الإجراء الافتراضي يكتب أرشيف ZIP مُنقّى إلى هذا الجهاز (بدون شبكة). يتضمن معلومات النظام (نظام التشغيل، الإصدارات، اسم المزوّد — وليس مفاتيح API أبداً) وسجلات الوكيل والبوابة وسطح المكتب بعد التنقية. تنقية الأسرار إلزامية ولا يمكن تعطيلها. رفع نسخة إلى تخزين Nous الداخلي اختياري عبر زر منفصل وليس الافتراضي.',
    upload: 'تصدير محلياً',
    exportLocal: 'تصدير محلياً',
    exporting: 'جارٍ التصدير…',
    uploadNous: 'رفع إلى Nous…',
    ...
    doneTitle: 'تم تصدير التشخيصات',
    doneDescription: 'كُتب أرشيف ZIP مُنقّى محلياً. يمكن إرفاقه بمشكلة GitHub أو محادثة الدعم عند الحاجة.',
  ...
  assistant: {
    thread: {
      ...
      errorOauthExpired: provider =>
        `انتهت صلاحية تسجيل الدخول إلى ${provider} أو تم إلغاؤها. سجّل الدخول مجدداً لمتابعة المحادثة.`,
    ...
    approval: {
      ...
      command: 'الأمر',
      resource: 'مورد MCP',
      grantRevision: 'إصدار المنحة',
      incompleteControlApproval: 'بيانات موافقة التحكم غير مكتملة ولا يمكن تنفيذها. ارفضها واطلب موافقة جديدة.',
