...
def finalize_turn(
    ...
    *,
    ...
    result = {
        ...
        "effective_model": getattr(getattr(agent, "last_route_observation", None), "effective_model", agent.model),
        "effective_provider": getattr(getattr(agent, "last_route_observation", None), "effective_provider", agent.provider),
        "route_observation": getattr(agent, "last_route_observation", None),
