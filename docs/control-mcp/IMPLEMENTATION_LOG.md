...
- The latest owner tests include one call through the actual `run_workflow` function with a fake native host. This proves identity plumbing, not Docker execution, provider entitlement or a live MCP mutation.
