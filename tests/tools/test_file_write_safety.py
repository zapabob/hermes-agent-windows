...
class TestMultiplexProfileCacheGuardsAreProfileScoped:
    ...
    Downstream owner remains ``tools.file_tools`` (COMPOSE); upstream extracted
    ``tools.file_tools_write_guards``.
    """
    ...
    def test_config_resolver_failure_stays_bound_to_active_profile(
        ...
        """When the primary config resolver raises, fallback stays on active home."""
        import tools.file_tools as ft
        from hermes_constants import (
            reset_hermes_home_override,
            set_hermes_home_override,
    ...
    def test_home_resolver_failure_keeps_exemption_on_active_profile(
        ...
        """When the primary home resolver raises, exemption stays on active home."""
        import tools.file_tools as ft
        from hermes_constants import (
            reset_hermes_home_override,
            set_hermes_home_override,
