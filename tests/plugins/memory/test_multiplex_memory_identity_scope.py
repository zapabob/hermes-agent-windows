...
Downstream COMPOSE of upstream a9838c (SR-20260913-004b). Mem0 OSS DirectOpenAILLM is absent on
this fork revision and is tracked separately.
"""
...
_DEFAULT_ENV = {
    "MEM0_USER_ID": "user-default",
    "MEM0_AGENT_ID": "agent-default",
    "MEM0_HOST": "http://mem0.default",
    "MEM0_MODE": "self_hosted",
    "SUPERMEMORY_CONTAINER_TAG": "tag-default",
    "SUPERMEMORY_BASE_URL": "https://sm.default",
    "RETAINDB_PROJECT": "proj-default",
    "RETAINDB_BASE_URL": "https://rdb.default",
    "OPENVIKING_API_KEY": "ov-default",
    "OPENVIKING_ACCOUNT": "acct-default",
    "OPENVIKING_USER": "user-default",
    "OPENVIKING_AGENT": "agent-default",
    "OPENVIKING_ENDPOINT": "http://ov.default",
    "HINDSIGHT_BANK_ID": "bank-default",
    "HINDSIGHT_MODE": "local_external",
    "HINDSIGHT_API_URL": "http://hs.default",
    "HERMES_HONCHO_HOST": "host-default",
    "HONCHO_BASE_URL": "https://honcho.default",
    "OPENAI_API_KEY": "sk-default",
    "OPENAI_BASE_URL": "https://openai.default/v1",
}


@pytest.fixture
def secondary_profile(monkeypatch, tmp_path):
    """Multiplex ON; default profile values in environ; secondary scope with only API keys."""
    ...
    token = secret_scope.set_secret_scope(
        {
            "RETAINDB_API_KEY": "rdb-b",
            "SUPERMEMORY_API_KEY": "sm-b",
            "HONCHO_API_KEY": "honcho-b",
            "MEM0_API_KEY": "mem0-b",
        }
    )
    try:
...
def test_secondary_profile_memory_identity_never_inherits_default_environ(secondary_profile):
    ...
    assert "user_id" not in cfg  # falls back to gateway-native id, not default's user
    ...
    assert (client._account, client._user) == ("default", "default")
