...
日本語: Windows向けの独立派生版です。今回のソース版は **0.21.3**（上流記録も 0.21.3）です。
...
Windows向け独立派生版のソースは0.21.3です。導入手順は第11節をご覧ください。
...
这是独立维护的 Windows 衍生版本，当前源码版本为0.21.3。
...
The source and release identity is Windows Workstation Edition 0.21.3.
...
verification procedure; older version examples are not evidence of a 0.21.3 release.
